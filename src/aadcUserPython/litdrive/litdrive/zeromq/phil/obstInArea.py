...
if __name__ == "__main__":
    ...
    zmq = ZmqServer("tcp://*:5556",
                    ...
                    #CHANGETO ["tLaserScannerData","tUltrasonicStruct", ____POSITION],
                    # ["tSignalValue","tSignalValue","tSignalValue","tSignalValue","tSignalValue","tSignalValue"]
    ...
    a = df.values
    ofs = 0 
    areas = a[ofs:4*NUM_AREAS+ofs,0]+1j*a[ofs:4*NUM_AREAS+ofs,1]
