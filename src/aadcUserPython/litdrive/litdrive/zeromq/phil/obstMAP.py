...
def process(imu,lidar,speed,ultraSonic): #TODO remove IMU and Speed
    ...
    # check globally
    # points = localToGlobal(x,y,heading,dist_compl)
    # checkObstacles(dist_compl,centerBoxCoordinate,box_width,box_height,threshold=2)
    ...
    if False: #((i+1)%20)==0
        ...
        plotMap()
        heading = 20
        print(loc_map_car_pos)
        projMap = projLocMap2Glob(locMap,loc_map_car_pos,0,0,heading)
        plotMap()
